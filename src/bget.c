...
Notes   : This file has been modified by Tristan Miller for use with the dl
          ...
          3. brel() has been modified as commented to make it more compatible
          ...
          For the complete original source code, see http://www.fourmilab.ch/
----------------------------------------------------------------------------*/
  ...
  void *buf;
{
    struct bfhead *b, *bn;
	/*
	** The following section was changed to make brel() more compatible
	** with free() (Tristan Miller 11/12/1999)
	*/
	/*   assert(buf != NULL); */
	if (buf == NULL)
	  return;
